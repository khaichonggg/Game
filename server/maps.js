...
const MAPS = {
  lava: {
    ...
    physics: { accel: 1100, damping: 2.4, ballDamping: 0.9 },
    collapse: { type: 'rings', first: 10, interval: 6, warn: 3, keep: 1 },
    goal: { x: 370, hw: 45, hh: 100 },
  },
  ice: {
    name: '冰川碎冰',
    icon: '🧊',
    ...
    physics: { accel: 760, damping: 1.4, ballDamping: 0.45 },
    collapse: { type: 'random', first: 5, interval: [1.5, 0.45], warn: 2, minTiles: 10 },
    goal: { x: 330, hw: 45, hh: 100 },
  },
  space: {
    name: '星际空间站',
    icon: '🪐',
